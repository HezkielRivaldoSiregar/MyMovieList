...
import com.dicoding.mymovielist.adapter.ListFavoriteShowAdapter
import com.dicoding.mymovielist.databinding.FragmentMovieShowFavoriteBinding


class ShowsFavoriteFragment : Fragment(R.layout.fragment_movie_show_favorite){

    private lateinit var binding : FragmentMovieShowFavoriteBinding
    private lateinit var adapter : ListFavoriteShowAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            adapter = ListFavoriteShowAdapter()
            showLoading(true)
            viewModel.getFavoriteShow().observe(viewLifecycleOwner, { shows ->
                showLoading(false)
            ...
            with(binding.rvShowsMovies) {
                ...
                adapter = this@ShowsFavoriteFragment.adapter
            }
        }
    }

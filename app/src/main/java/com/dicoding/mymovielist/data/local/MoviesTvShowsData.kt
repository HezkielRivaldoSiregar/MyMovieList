...
object MoviesTvShowsData {
    ...
    fun generateMoviesData(): List<Movies> {
        ...
        movies.add(
            Movies(
                ...
                "05/10/2018",
                "Drama, Romance, Music",
                "https://www.themoviedb.org/t/p/original/vZDCSXwcKPWcrhXDia8thmaJD1X.jpg",
        ...
        movies.add(
            Movies(
                ...
                "21/11/2018",
                "Drama",
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/vTh7cpduacLxdXChJq0QxBYMAhU.jpg",
    ...
    fun generateRemoteMoviesData(): List<MovieResponse> {
    ...
    fun generateTvShowsData(): List<TvShows> {
        ...
        tvShows.add(
            TvShows(
                ...
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/yXggMemopUDHwPgmi6X9Wh2BQra.jpg",
        ...
        tvShows.add(
            TvShows(
                ...
                "21",
                "Animation,Comedy",
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/buwzKwQXlqOAz3xL23lf6QM7qhB.jpg",
        ...
        tvShows.add(
            TvShows(
                ...
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/7QSM3AsgWXctWBm7OFov9dGdZgt.jpg",
        ...
        tvShows.add(
            TvShows(
                ...
                "17",
                "Drama",
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/3IIBf6VlwEyKAX4cN2XCM1gKdgM.jpg",
        ...
        tvShows.add(
            TvShows(
                ...
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/xHCfWGlxwbtMeeOnTvxUCZRGnkk.jpg",
        ...
        tvShows.add(
            TvShows(
                ...
                "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/yD1R7QCNqrcaf15AxkLbgRLI9Dz.jpg",
    ...
    fun generateRemoteTvShowsData(): List<TvResponse> {
